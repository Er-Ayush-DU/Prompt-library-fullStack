...
export default async function SearchPage({
  ...
  // Next.js 15 passes searchParams as a promise internally
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          {hasResults ? (
            ...
            <>
              ...
              <p className="text-lg md:text-xl text-gray-200 max-w-2xl mb-8">
                Your search for{" "}
                <span className="text-pink-300 font-bold">"{query}"</span>{" "}
                didn’t return any results.
              </p>
              <p className="text-gray-300">Try different keywords or remove filters.</p>
            </>
          )}
        </div>
      ...
      <main className="container mx-auto px-4 py-16">
        {hasResults ? (
          ...
          <div className="flex flex-col items-center py-20">
            <div className="bg-gray-200 border-2 border-dashed rounded-xl w-32 h-32 mb-6" />
            <p className="text-gray-500 text-center max-w-md">
              Try searching for popular terms like <strong>AI Art</strong>,{" "}
              <strong>Logo Design</strong>, or <strong>Photography</strong>.
            </p>
          </div>
        )}
      </main>

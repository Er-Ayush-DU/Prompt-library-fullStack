...
// ✅ Extracted into a separate component wrapped in <Suspense>
function UploadContent() {
  ...
  if (status !== "authenticated")
    return (
      <p className="container mx-auto p-4">Please sign in to upload</p>
    );
...
// ✅ This ensures useSearchParams() works safely with Suspense
